...
/*./yourcode.out fullyconnected a1a.inputmatrix.txt a1a.weightmatrix.txt a1a.biasmatrix.txt kartik.txt*/
/*./yourcode.out fullyconnected openblas a1a.inputmatrix.txt a1a.weightmatrix.txt a1a.biasmatrix.txt kartik.txt*/
/*./yourcode.out fullyconnected pthread a1a.inputmatrix.txt a1a.weightmatrix.txt a1a.biasmatrix.txt kartik.txt*/
...
int main(int argc, char** argv){
	...
	if (argc == 7 && strcmp(argv[1],"fullyconnected")==0 && strcmp(argv[2],"openblas")==0){
		fullyconnectedopenblas(argv[3],argv[4],argv[5],argv[6]);
		return 0;
	}
